...
\restrict SJi6IzNic9bttkhcfJ55zEQSyEx8rgr97Ooor8FSFI1OeLJuBb8Ptwj77EU22p3
...
exception
  when others then
    raise notice 'Error executing SQL: %', sql;
    raise;
end;
$$;
...
CREATE FUNCTION public.expire_old_signals() RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
begin
...
--
-- Name: fn_signals_set_candle_ts(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.fn_signals_set_candle_ts() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
  if new.candle_ts is null then
    if coalesce(new.features->>'ts','') <> '' then
      new.candle_ts := (new.features->>'ts')::timestamptz;
    elsif new.timeframe='1h' then
      new.candle_ts := date_trunc('hour', new.generated_at);
    elsif new.timeframe='15m' then
      new.candle_ts := date_trunc('hour', new.generated_at)
                       + make_interval(mins => (extract(minute from new.generated_at)::int/15)*15);
    end if;
  end if;
  return new;
end;
...
--
-- Name: insert_signal(jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.insert_signal(p jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
declare rid uuid;
begin
  update public.signals
    set is_active=false, status='expired', closed_ts=now()
  where symbol = (p->>'symbol')
    and status='active'
    and coalesce(is_active,true);

  insert into public.signals
    (id, ts, expiry_ts, symbol, timeframe, side, entry, sl, tp1, tp2, tp3,
     probability, model_version, rationale, status, is_active, raw)
  values
    (coalesce((p->>'id')::uuid, gen_random_uuid()),
     (p->>'ts')::timestamptz,
     (p->>'expiry_ts')::timestamptz,
     p->>'symbol', p->>'timeframe', p->>'side',
     (p->>'entry')::numeric, (p->>'sl')::numeric,
     (p->>'tp1')::numeric, (p->>'tp2')::numeric, (p->>'tp3')::numeric,
     (p->>'probability')::numeric, p->>'model_version', p->>'rationale',
...
--
-- Name: signals_set_candle_ts(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.signals_set_candle_ts() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare
  _ts timestamptz;
  _tf text;
begin
  -- timeframe na małe litery
  if new.timeframe is not null then
    new.timeframe := lower(new.timeframe);
  end if;

  -- kandydat czasu świecy: NEW.candle_ts -> features->>'ts' -> generated_at
  _ts := coalesce(
           new.candle_ts,
           nullif(new.features->>'ts','')::timestamptz,
           new.generated_at
         );

  -- normalizacja wg TF
  _tf := coalesce(new.timeframe, '1h');

  if _tf = '1h' then
    new.candle_ts := date_trunc('hour', _ts);
  elsif _tf = '15m' then
    new.candle_ts := date_trunc('hour', _ts)
                     + make_interval(mins => (extract(minute from _ts)::int/15)*15);
  else
    -- fallback: bez zmian, ewentualnie sprowadź do minuty
    new.candle_ts := date_trunc('minute', _ts);
  end if;
...
CREATE TABLE public.signals (
    ...
    timeframe text DEFAULT '15m'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT signals_direction_check CHECK ((direction = ANY (ARRAY['LONG'::text, 'SHORT'::text])))
);
...
--
-- Name: signals_meta; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.signals_meta (
...
ALTER TABLE ONLY public.ohlcv
    ADD CONSTRAINT ohlcv_pkey PRIMARY KEY (symbol, ts, timeframe);
...
--
-- Name: signals_meta signals_meta_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals_meta
    ADD CONSTRAINT signals_meta_pkey PRIMARY KEY (signal_id);
...
--
-- Name: signals signals_symbol_timeframe_created_at_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals
    ADD CONSTRAINT signals_symbol_timeframe_created_at_key UNIQUE (symbol, timeframe, created_at);
...
--
-- Name: idx_ohlcv_symbol_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ohlcv_symbol_time ON public.ohlcv USING btree (symbol, timeframe, ts DESC);
...
CREATE INDEX idx_outbox_sent ON public.outbox USING btree (sent);
...
CREATE INDEX idx_outbox_status ON public.outbox_events USING btree (status, created_at);


--
-- Name: idx_signals_symbol_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_signals_symbol_time ON public.signals USING btree (symbol, timeframe, created_at DESC);
...
--
-- Name: signals_meta signals_meta_signal_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.signals_meta
    ADD CONSTRAINT signals_meta_signal_id_fkey FOREIGN KEY (signal_id) REFERENCES public.signals(id) ON DELETE CASCADE;
...
--
-- Name: ohlcv; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: signals_meta; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION expire_old_signals(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.expire_old_signals() TO anon;
GRANT ALL ON FUNCTION public.expire_old_signals() TO authenticated;
GRANT ALL ON FUNCTION public.expire_old_signals() TO service_role;


--
-- Name: FUNCTION fn_signals_set_candle_ts(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.fn_signals_set_candle_ts() TO anon;
GRANT ALL ON FUNCTION public.fn_signals_set_candle_ts() TO authenticated;
GRANT ALL ON FUNCTION public.fn_signals_set_candle_ts() TO service_role;


--
-- Name: FUNCTION insert_signal(p jsonb); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.insert_signal(p jsonb) TO anon;
GRANT ALL ON FUNCTION public.insert_signal(p jsonb) TO authenticated;
GRANT ALL ON FUNCTION public.insert_signal(p jsonb) TO service_role;


--
-- Name: FUNCTION signals_set_candle_ts(); Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON FUNCTION public.signals_set_candle_ts() TO anon;
GRANT ALL ON FUNCTION public.signals_set_candle_ts() TO authenticated;
GRANT ALL ON FUNCTION public.signals_set_candle_ts() TO service_role;
...
--
-- Name: TABLE ohlcv; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.ohlcv TO anon;
GRANT ALL ON TABLE public.ohlcv TO authenticated;
GRANT ALL ON TABLE public.ohlcv TO service_role;
...
--
-- Name: SEQUENCE signals_id_seq; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE signals_meta; Type: ACL; Schema: public; Owner: -
--

GRANT ALL ON TABLE public.signals_meta TO anon;
GRANT ALL ON TABLE public.signals_meta TO authenticated;
GRANT ALL ON TABLE public.signals_meta TO service_role;
...
\unrestrict SJi6IzNic9bttkhcfJ55zEQSyEx8rgr97Ooor8FSFI1OeLJuBb8Ptwj77EU22p3
